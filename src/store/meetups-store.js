...
export const meetups = writable([
	{
		...
		description:
			'Amazing, awesome, cool fastest bootcamp in the world! Become a Senior in just 3 minutes!',
		image:
	...
	{
		id: 'm3',
		title: 'Become a Magician!',
		description: 'Magic tricks are cool! Cards are cool! You are cool!',
		image: 'https://cdn.arstechnica.net/wp-content/uploads/2020/07/primingTOP.jpg',
		address: 'Miami, 33101',
		email: 'magicians@test.com',
		isFavorite: false
	}
]);
